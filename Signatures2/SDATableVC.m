...
@interface SDATableVC ()

@end

@implementation SDATableVC
...
- (void)viewDidLoad
{
    ...
    [self.tableView registerClass:[SDATVCell class] forCellReuseIdentifier:@"cell"];
}
...
{
    SDATVCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
